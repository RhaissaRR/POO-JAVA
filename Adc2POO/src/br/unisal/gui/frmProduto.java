...
public class frmProduto extends JFrame implements ActionListener {
	...
	//Metodo de Ação aos componentes
	...
	private void Pesquisar() {
		String codigoPesquisar = JOptionPane.showInputDialog(this, "Digite o código do produto");
		
		if (bdProduto.contains(codigoPesquisar)) {
			JOptionPane.showMessageDialog(this, "Produto encontrado!", "Pesquisa do Produto", JOptionPane.INFORMATION_MESSAGE);
		}else {
			JOptionPane.showMessageDialog(this, "Código de Produto não encontrado!", "Pesquisa do Produto", JOptionPane.ERROR_MESSAGE);
		}
